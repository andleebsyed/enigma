export function Intro() {
    return (
        <section className="max-w-md mt-10 m-3">
...
<p className="text-center pb-4 text-white">if you answer correctly you willl be rewarded with <span className="text-green font-bold">5 points</span></p>
